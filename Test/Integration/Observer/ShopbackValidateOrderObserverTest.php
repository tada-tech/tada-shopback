...
class ShopbackValidateOrderObserverTest extends TestCase
{
    ...
    public function testExecute()
    {
        ...
        $this->publisher->publish(ShopbackValidateOrderObserver::TOPIC_NAME, $cashbackTrackingEntity);

        $messageCollection = $this->_getListMessages(ShopbackValidateOrderObserver::TOPIC_NAME);
